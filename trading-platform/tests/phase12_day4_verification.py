...
def verify_new_routes_and_readiness() -> bool:
    try:
        ...
        passed = (
            ...
            and readiness["status"] in {"SMC_INTELLIGENCE_READY", "RISK_QUALIFICATION_READY", "EXECUTION_BRIDGE_READY"}
            ...
            and nifty["status"] in {"SMC_INTELLIGENCE_READY", "RISK_QUALIFICATION_READY", "EXECUTION_BRIDGE_READY"}
            and nifty["ready"] is False
            and summary["nifty50_ready"] is False
            and summary["overall_completion_percentage"] in {96, 97, 98}
        )
