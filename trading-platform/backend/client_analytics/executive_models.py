...
ReadinessState = Literal["READY", "WARNING", "PENDING", "PENDING_IMPLEMENTATION"]
...
class ExecutiveDashboardSummary(BaseModel):
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        self.overall_completion_percentage = min(float(self.overall_completion_percentage), 90.0)
