...
class MT5PositionMonitoringService:
    ...
    def _monitor_position(self, position: dict[str, Any], journal_records: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        return {
            ...
            "validation_session_id": journal.get("validation_session_id") if journal else "",
            "session_id": journal.get("validation_session_id") if journal else "",
            "adaptive_strategy_level": journal.get("adaptive_strategy_level") if journal else None,
