...
def verify_readiness_and_executive() -> bool:
    try:
        ...
        passed = (
            readiness["status"] in {"RISK_QUALIFICATION_READY", "EXECUTION_BRIDGE_READY", "ANALYTICS_INTEGRATED"}
            ...
            and nifty["status"] in {"RISK_QUALIFICATION_READY", "EXECUTION_BRIDGE_READY", "ANALYTICS_INTEGRATED"}
            and nifty["ready"] is False
            and summary["nifty50_ready"] is False
            and summary["overall_completion_percentage"] in {97, 98, 99}
        )
