    ...
    def _read_state(self) -> dict:
        ...
        try:
            ...
            return {
                ...
                "margin_level": str(getattr(account, "margin_level", "")) if account else "",
                "free_margin": str(getattr(account, "margin_free", "")) if account else "",
                "used_margin": str(getattr(account, "margin", "")) if account else "",
