...
class ExecutiveDashboardService:
    ...
    def get_instrument_readiness(self) -> dict:
        return {
            ...
            "xauusd_status": "READY",
            "eurusd_status": "READY",
            "nifty50_status": "EXECUTION_BRIDGE_READY",
            "nifty50_readiness_detail": "BROKER_SELECTION_CREDENTIALS_ORDER_PLACEMENT_PENDING",
            "simulation_only": True,
            "live_execution_enabled": False,
            "broker_execution_enabled": False,
        }
    ...
    def get_completion_report(self) -> dict:
        return {
            ...
            "pending": [
                ...
                "NIFTY50 Broker Credentials",
                "NIFTY50 Real Broker API Connection",
                "NIFTY50 Order Placement Approval",
