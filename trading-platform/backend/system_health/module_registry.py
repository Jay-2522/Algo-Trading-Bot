MODULE_REGISTRY: list[dict] = [
    ...
    {"name": "client_analytics", "route": "/client-analytics/status"},
    ...
    {"name": "production_readiness_certification", "route": "/production-readiness/status"},
    ...
    {"name": "nifty50_foundation", "route": "/nifty50/status"},
    {"name": "nifty50_market_data_placeholder", "route": "/nifty50/market-data/snapshot"},
    {"name": "nifty50_broker_registry", "route": "/nifty50/brokers"},
